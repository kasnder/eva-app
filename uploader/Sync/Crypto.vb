...
ByVal key As String) As String
        'Setting auslesen
        If key Is Nothing Then key = My.Settings.key

        'Local password encryption initialised?
        '-> get random key for encryption
        If My.Settings.key = "" Then key = Crypto.GetSeed(32)
        Return key
    End Function
    ...
    Public Shared Function EncryptString(ByVal plaintext As String, Optional ByVal key As String = Nothing) As String
        ...
        TripleDes.Key = Crypto.TruncateHash(key, TripleDes.KeySize \ 8)
        TripleDes.IV = Crypto.TruncateHash("", TripleDes.BlockSize \ 8)
