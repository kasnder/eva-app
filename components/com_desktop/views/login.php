...
<div>
    ...
    switch (Common::getRequest('errorType')):
        case 'auth'?>
            ...
            <?php break; ?>
        <?php case 'password': ?>
        <p><b>Passwort muss geändert werden. Dazu bitte einmalig <a target="_blank"
                                                                    href="<?php Common::secureEcho(Config::ENVIRONMENT_URL); ?>">hier</a>
                einloggen.</b></p>
        <?php break; ?>
    <?php case 'config': ?>
        <p><b>Benutzer muss eingerichtet werden. Dazu bitte einmalig <a target="_blank" href="index.php?view=touch">hier</a> über ein unterstütztes
                Endgerät einloggen oder die Web-Administration(<?php Common::secureEcho(Config::CONTACT); ?>) der Schule kontaktieren.</b></p>
    <?php endswitch; ?>
...
<div style="margin-left:auto; margin-right:auto; max-width:500px;">
    <img style="width: auto;height: 120px;display: block; margin-left: auto; margin-right: auto; margin-bottom: 1em;"
    ...
    <form action="index.php?component=desktop&amp;view=login" method="post" class="form" id="loginForm">
        ...
        <div class="form-group">
            <input id=username value="<?php Common::secureEcho(Common::getRequest('username')); ?>" name="username" type="text" class="form-control"
